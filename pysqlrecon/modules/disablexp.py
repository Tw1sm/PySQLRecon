...
app = typer.Typer()
COMMAND_NAME = "disablexp"
HELP = "[red][PRIV][/] Disable xp_cmdshell [I,L]"
...
def main(ctx: typer.Context):
    ...
    if pysqlrecon.link is not None:        
        ...
        logger.info(f"Disabling xp_cmdshell on {pysqlrecon.link} via {pysqlrecon.target}")
        pysqlrecon.linked_module_toggle("xp_cmdshell", "0")
