...
app = typer.Typer()
COMMAND_NAME = "credentials"
HELP = "[bright_black][NORM][/] Display encrypted credentials [I]"
...
def main(ctx: typer.Context):
    ...
    logger.info("Listing valuted credentials")

    query = "select UserName, Usage from [dbo].[vSMS_SC_UserAccount]"
